...
// 파일 경로, 명령어 
	$fileLocation			=	"/usr/local/apache/htdocs/project_os/c_program/add  > /dev/null &";
	$gpioLocation			=	"/usr/local/apache/htdocs/project_os/DB/gpio/";
	$turnOff				=	"ps -ef | grep /usr/local/apache/htdocs/project_os/c_program/add";
	$killProcess			=	"kill ";
