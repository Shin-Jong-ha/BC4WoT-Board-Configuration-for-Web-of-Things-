...
// 이미지 경로
	$imageLocation		=		"/usr/local/apache/htdocs/project_os/DB/homepage/image";
	$imageLocationResult=		"/usr/local/apache/htdocs/project_os/DB/homepage/image";
// 폴더에 있는 파일을 전부 읽어온다.
...
// 외부 라이브러리
	$outsideLocation	=		"/project_os/DB/outside_library";

// 외부 라이브러리 값을 읽어온다.
	$fpOutside			=		dir("/usr/local/apache/htdocs/project_os/DB/outside_library");
